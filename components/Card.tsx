  ...
  return (
    <section id = "about">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 max-w-7xl mx-auto w-full">
          <WobbleCard
            containerClassName="col-span-1 lg:col-span-2 h-full bg-purple-400 min-h-[500px] lg:min-h-[300px]"
            className=""
          >
          ...
          <WobbleCard containerClassName="col-span-1 bg-purple-300 min-h-[300px]">
            {/*
          ...
          <WobbleCard containerClassName="col-span-1 lg:col-span-3 bg-purple-200 min-h-[500px] lg:min-h-[600px] xl:min-h-[300px]">
