        ...
        content: (
            <div>
                ...
                <ul className="list-disc list-inside text-neutral-800 dark:text-white text-xs md:text-sm font-normal mb-8">
                    ...
                    <li>Managed GitHub deployment and SDK authentication, contributing to documentation and project demonstrations.</li>
                </ul>
        ...
        content: (
            <div>
                ...
                <ul className="list-disc list-inside text-neutral-800 dark:text-white text-xs md:text-sm font-normal mb-8">
                    ...
                    <li>Developed a testing script for PCIe Fixture kit characterization for Gen 4 and 5, and enhanced USB 3 RX/TX scripts for Host Program Control.</li>
                </ul>
                <div className="grid grid-cols-2 gap-4">
                </div>
            </div>
        ...
        content: (
            <div>
                ...
                <ul className="list-disc list-inside text-neutral-800 dark:text-white text-xs md:text-sm font-normal mb-8">
                    ...
                    <li>Enhanced visual capabilities through object detection using OpenCV for Project Periscope.</li>
                    <li>Administered SQL and NoSQL databases, focusing on database design and query optimization.</li>
                </ul>
                <div className="grid grid-cols-2 gap-4">
                </div>
            </div>
